---@mod opencode.git Git integration for opencode.nvim
---@brief [[
--- This module provides git integration functionality for opencode.nvim.
...
function M.get_git_root()
  ...
  if vim.env.OPENCODE_TEST_MODE == 'true' then
