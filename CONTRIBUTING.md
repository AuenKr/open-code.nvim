...
1. Check if the issue already exists in the [issues section](https://github.com/AuenKr/open-code.nvim/issues)
...
- Update the Neovim help documentation in doc/opencode.txt
