...
describe('git', function()
  ...
  local original_env_test_mode = vim.env.OPENCODE_TEST_MODE
  ...
  describe('get_git_root', function()
    it('should handle io.popen errors gracefully', function()
      ...
      vim.env.OPENCODE_TEST_MODE = nil
    ...
    it('should extract git root in a git directory', function()
      ...
      vim.env.OPENCODE_TEST_MODE = 'true'
  ...
  vim.env.OPENCODE_TEST_MODE = original_env_test_mode
end)
